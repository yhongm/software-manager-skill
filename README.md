...
> 软件产品经理/软件开发经理知识技能 - 主动式产品咨询 + PRD生成 + Mermaid图表

## 概述

Software Manager Skill 是一款面向 Claude Code 的软件产品经理助手。它遵循**主动式产品咨询流程**，帮助用户完成从需求分析到PRD文档输出的完整产品工作流。
...
```
确认需求 → 提问澄清 → 网络搜索 + RAG搜索 → 产品规划 → PRD文档保存本地 + Mermaid图表
```
...
**自动保存**: 文档自动保存到 `C:\Users\yhong\projects\{产品名称}\PRD\{产品名称}_PRD_v0.1.md`
...
> ...
> PRD文档 + Mermaid图表
> PRD已保存到: `C:\Users\yhong\projects\running-app\PRD\running-app_PRD_v0.1.md`
